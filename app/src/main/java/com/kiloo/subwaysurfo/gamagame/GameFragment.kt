...
import com.kiloo.subwaysurfo.databinding.FragmentGameBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            binding.btnImgRules.setOnClickListener {
                findNavController().navigate(R.id.action_gameFragment_to_someRulesFragment)
            }
            binding.btnImgSettings.setOnClickListener {
                findNavController().navigate(R.id.action_gameFragment_to_settingsFragment)
            }
            binding.btnImgLeadearboard.setOnClickListener {
